...
server379: server/server.c server/daemonize.c server/main_events.c server/open_main_fd.c server/running.c server/user_coms.c server/user_handler.c server/user_list.c
	gcc -o server379 -pthread server/server.c server/daemonize.c server/main_events.c server/open_main_fd.c server/running.c server/user_coms.c server/user_handler.c server/user_list.c
	mkdir -p bin
	mv server379 bin/
